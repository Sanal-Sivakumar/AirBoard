...
Future<bool> showPairingSheet(BuildContext context, String deviceName) async {
  const fingerprint = [
    'E7:D4:37:D4', '32:C0:AB:EC',
    'B8:DB:62:0F', '8A:E0:3D:43',
    'AB:FA:A0:64', '70:ED:D1:FE',
    '43:32:67:0F', '22:72:6F:21',
  ];
                ...
                GlassCard(
                  ...
                  child: Row(children: [
                    ...
                    Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(deviceName, style: AB.title),
                        Text('ID: 28208b6f-09e…',
